...
# Write Instructions
st.markdown('The PyMILab Schema Configuration Manager is used to configure a Granta MI Schema to the neutral JSON output files generated by Py MILab. For all questions and concerns, please contact brandon.l.hearley@nasa.gov')
