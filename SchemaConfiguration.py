...
if "excel_flag" not in st.session_state:
    ...
    with st.expander('Record Placement'):
        ...
        def create_cond_table(m,n):
            ...
            if st.session_state[f'folder_lev_b_{m}'] != 1:
                    ...
                    if 'placement_flags' in st.session_state:
                        if st.session_state['placement_flags'] == 1:
                            if 'Level ' + str(m+1) in list(Config['Placement'].keys()):
                                idx = st.session_state['single_json'].index(Config['Placement']['Level ' + str(m+1)][1])
                ...
                with grid_sec[3]:
                    ...
                    if 'placement_flags' in st.session_state:
                        if st.session_state['placement_flags'] == 1:
                            if 'Level ' + str(m+1) in list(Config['Placement'].keys()):
                                idx = Config['Placement']['Level ' + str(m+1)][3]
            ...
            with grid_sec[4]:
                ...
                if 'placement_flags' in st.session_state:
                    if st.session_state['placement_flags'] == 1:
                        if 'Level ' + str(m+1) in list(Config['Placement'].keys()):
                            idx = st.session_state['single_json'].index(Config['Placement']['Level ' + str(m+1)][4])
            ...
            with grid_sec[5]:
                ...
                if 'placement_flags' in st.session_state:
                    if st.session_state['placement_flags'] == 1:
                        if 'Level ' + str(m+1) in list(Config['Placement'].keys()):
                            idx = Config['Placement']['Level ' + str(m+1)][5]
        ...
        def create_folder_table(m):
            ...
            with grid_lev[1]:
                if "condition_list" in st.session_state:
                    ...
                    cond_val = 1
                if m == 0:
                    st.number_input('Conditions', value = cond_val, min_value = 0, step = 1, key = f'folder_lev_b_{m}')
                else:
                    st.number_input('Conditions', value = cond_val, min_value = 0, step = 1, key = f'folder_lev_b_{m}', label_visibility = "collapsed")
        ...
        # Turn off the flags
        if 'placement_flags' in st.session_state:
            st.session_state['placement_flags'] = 2
